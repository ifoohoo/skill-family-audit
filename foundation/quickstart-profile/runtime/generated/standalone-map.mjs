...
const STANDALONE_VALIDATORS = Object.freeze({
  ...
  "https://contracts.skill-family.example/skill-family-audit/candidate/v2/foundation-adoption-exemption.json": validate202012.__skillFamilyFoundationValidator_00006,
  "https://contracts.skill-family.example/skill-family-audit/candidate/v2/methods/behavior/parameters.json": validate202012.__skillFamilyFoundationValidator_00007,
  "https://contracts.skill-family.example/skill-family-audit/candidate/v2/methods/behavior/result.json": validate202012.__skillFamilyFoundationValidator_00008,
  "https://contracts.skill-family.example/skill-family-audit/candidate/v2/methods/conformance/parameters.json": validate202012.__skillFamilyFoundationValidator_00009,
  "https://contracts.skill-family.example/skill-family-audit/candidate/v2/methods/conformance/result.json": validate202012.__skillFamilyFoundationValidator_00010,
  "https://contracts.skill-family.example/skill-family-audit/candidate/v2/methods/release/parameters.json": validate202012.__skillFamilyFoundationValidator_00011,
  "https://contracts.skill-family.example/skill-family-audit/candidate/v2/methods/release/result.json": validate202012.__skillFamilyFoundationValidator_00012,
  "https://contracts.skill-family.example/skill-family-audit/candidate/v2/methods/runtime/parameters.json": validate202012.__skillFamilyFoundationValidator_00013,
  "https://contracts.skill-family.example/skill-family-audit/candidate/v2/methods/runtime/result.json": validate202012.__skillFamilyFoundationValidator_00014,
  "https://contracts.skill-family.example/skill-family-audit/candidate/v2/plugin-project-observation.json": validate202012.__skillFamilyFoundationValidator_00015,
