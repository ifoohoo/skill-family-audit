...
---
<!-- platform-projection: platform=workbuddy; logical=skill-family-audit:runtime-audit; source=skills/skill-family-audit-runtime -->
...
- **status**: candidate
- **候选身份**: `skill-family-audit:0.1.4-candidate`
...
| 文件 | 说明 |
|---|---|
| `task.json` | 符合 task.schema.json 的任务记录 |
| `result.json` | 符合 result.schema.json 的结果记录 |
